...
#' @param plt_type input from overlap.type to create either Histigram or Density
#' @author George Perrett, Joe Marlo
#'
#' @return ggplot object
#' @export
plot_overlap_vars <- function(.data, selected_cols, plt_type){
