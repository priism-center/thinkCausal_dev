      ...
      column(4,
             wellPanel(
               ...
               selectInput(ns('analysis_random_intercept'),
                           ...
                           label = create_info_icon('Include clustered or nested data:', 'Classes within schools or patients within medical practices are examples of clustered/nested data'),
                           choices = c("", "Unsure", "No", "Yes")),
             )
      ),
      column(4,
