Now we get to see the run time for Alex without the Hypershoe. Alex would have finished the race in 3.2 hours.  Now we know that the Hypershoe did indeed have a causal effect on Alex's run time.
