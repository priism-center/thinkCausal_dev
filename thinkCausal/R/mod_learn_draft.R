...
mod_learn_draft_ui <- function(id){
  ns <- NS(id)
...
#' learn_draft Server Functions
#'
#' @noRd
mod_learn_draft_server <- function(id){
...
# mod_learn_draft_ui("learn_draft_1")

## To be copied in the server
# mod_learn_draft_server("learn_draft_1")
