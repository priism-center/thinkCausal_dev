...
mod_learn_test_server <- function(id){
  moduleServer( id, function(input, output, session){
    ...
    # output$item1 <- renderPlot({
    #   ggplot2::qplot(1:10) + ggplot2::labs(title = 'Section 1')
    # })
    # output$item2 <- renderPlot({
    #   ggplot2::qplot(1:10, 1:10) + ggplot2::labs(title = 'Section 2')
    # })
    # output$item3 <- renderPlot({
    #   ggplot2::qplot(rnorm(10), 1:10) + ggplot2::labs(title = 'Section 3')
    # })
    #
    #
    ...
    output$scroll_visual <- renderUI({
      ...
      items$p2 <- #tagList(
        ...
        # data.frame(1:10)
      #)
      items$p3 <- ggplot2::qplot(rnorm(10), 1:10) + ggplot2::labs(title = 'Section 3')
