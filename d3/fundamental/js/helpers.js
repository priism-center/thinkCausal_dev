...
fundamental.generateData = function(mean, sd, n){
...
fundamental.sliderTimeouts = [];
fundamental.killSliderAnimations = function(){
    fundamental.sliderTimeouts.map(clearTimeout)
    fundamental.sliderTimeouts = []
}
