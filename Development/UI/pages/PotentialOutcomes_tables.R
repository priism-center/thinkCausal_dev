  ...
  $("#submit2").click(function() {
    ...
    for (i = 1; i <= q_tot; i++) {
      ...
      if (r==t_vals[i-1]) {
        q2 = q2 + 1;
        $("#table6 #add" + i).text(r);
        $("#table6 #add" + i).append("    " + \'<span class="glyphicon glyphicon-ok" style="color:green"></span>\');
      }
      else {
        $("#table6 #add" + i).text(r);
        $("#table6 #add" + i).append("    " + \'<span class="glyphicon glyphicon-remove" style="color:red"></span>\');
      }
    };
  ...
  $("#submit3").click(function() {
    ...
    for (i = 1; i <= q_tot; i++) {
      ...
      if (r==t_vals[i-1]) {
        q3 = q3 + 1;
        $("#table9 #add" + i).text(r);
        $("#table9 #add" + i).append("    " + \'<span class="glyphicon glyphicon-ok" style="color:green"></span>\');
      }
      else {
        $("#table9 #add" + i).text(r);
        $("#table9 #add" + i).append("    " + \'<span class="glyphicon glyphicon-remove" style="color:red"></span>\');
      }
    };
