...
ui <- fluidPage(
    fluidRow(column(1), column(10,
        ...
        Under the potential outcomes framework, Aki and Audrey can receive one of the 
        two conditions. Different possible conditions are represented by the letter Z. 
        Z = 1 represents receiving the treatment condition (taking the fish oil) 
        and Z = 0 represents receiving the control condition (not taking the fish oil)."),
    ...
    p("The individual treatment effect(ITE) is the causal effect of the fish oil supplements for each individual.
    ...
    p("The fundamental problem of causal inference is that both potential outcomes Y1 and Y0
      can never be observed at the same time. Seeing both Y1 and Y0 at the same time would require an
      'All Knowing' view that theoretically exists but is never available to the researcher. 
      Under the researcher view, each participant has a single value of Z and Y(either Y1 or Y0). 
      
      In practice, participants 
      only receive the treatment or control conditions and a single value of Z and 
    ...
    p("Looking between the All Knowing and Researcher views 
      reveals the importance of the potential outcomes framework. 
      Access to the true All Knowing view shows us that the fish oil supplements 
      ...
      conclusion that the fish oil supplements have no causal effect on blood pressure.
      When you have access to the All Knowing view of both potential outcomes, 
      you can see that the fish oil supplements would have reduced both Aki's blood pressure by 7 points and Audreys' blood pressure by 5 points."),
    
    br(), 
    
    p("While the All Knowing view is never available to researchers in practice, 
      researchers use experimental designs and modeling methods to predict 
